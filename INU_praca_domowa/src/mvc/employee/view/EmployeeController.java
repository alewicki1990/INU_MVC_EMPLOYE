...
public class EmployeeController {
	...
	private void initialize() {
		...
		jobTitleColumn.setCellValueFactory(cellData -> cellData.getValue().emailProperty());
	...
	private void editEmployee() throws IOException {
		...
		if (selEmp != null) {
			...
			FXMLLoader fxmlLoader = new FXMLLoader(Main.class.getResource("view/EmpEdit.fxml"));
			AnchorPane fxmlLayout = fxmlLoader.load();
			EmpEditController fxmlController = fxmlLoader.getController();
	...
	private void insertEmployee() throws IOException {
		...
		stage.setResizable(false);
		FXMLLoader fxmlLoader = new FXMLLoader(Main.class.getResource("view/EmpInsert.fxml"));
		AnchorPane fxmlLayout = fxmlLoader.load();
		EmpInsertController fxmlController = fxmlLoader.getController();
